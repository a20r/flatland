...
(examples of which can be seen in Figs~\ref{fig:2d_examples}
and~\ref{fig:3d_examples}).
...
You can see examples of our code running in Fig~\ref{fig:3d_examples}. The
